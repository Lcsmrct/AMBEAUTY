...
import { Mail, Lock, User, Sparkles, Instagram } from 'lucide-react';
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({ 
          ...
          description: result.error || "Identifiants incorrects. Vérifiez votre email et mot de passe.",
          variant: "error"
        });
      }
    } catch (error) {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({ 
          ...
          description: result.error || "Une erreur s'est produite lors de la création du compte.",
          variant: "error"
        });
      }
    } catch (error) {
