...
const contactInfo = [
  {
    icon: MapPin,
    title: "Visitez-nous",
    details: ["Studio de Beauté Professionnel", "Paris, France"],
    color: "text-primary"
  },
  {
    icon: Phone,
    title: "Appelez-nous",
    details: ["+33 1 23 45 67 89", "Disponible pendant les heures d'ouverture"],
    color: "text-accent-gold"
  },
  {
    icon: Mail,
    title: "Ecrivez-nous",
    details: ["Am.beautyy2@gmail.com", "Réponse sous 24h"],
    color: "text-primary"
  },
  {
    icon: Clock,
    title: "Horaires d'ouverture",
    details: ["Lun-Sam: 9h00 - 19h00", "Dimanche: Sur rendez-vous uniquement"],
    color: "text-accent-gold"
  }
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Prêt à réserver votre rendez-vous ou avez des questions ? Nous sommes là pour vous aider
          </p>
        </motion.div>
        ...
        >
          <Card className="max-w-md mx-auto bg-primary text-primary-foreground">
            <CardContent className="p-8 text-center">
              ...
              <p className="mb-4">Restez informé de nos dernières réalisations</p>
              <a 
